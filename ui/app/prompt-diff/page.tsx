...
export default async function PromptDiffIndex() {
  let opts: OptRun[] = [];
  try {
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-10 py-12">
      <header className="border-b border-line pb-6">
        <h1 className="font-display text-display-md tracking-tight">Prompt diffs</h1>
        <p className="mt-2 text-ink-secondary">
          Side-by-side baseline vs GEPA-tuned prompts.
        </p>
      </header>
